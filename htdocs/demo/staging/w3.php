...
<header class="w3-container w3-theme w3-padding" id="myHeader">
  ...
  <h1 class="w3-xxxlarge w3-animate-bottom">Cookie Tool</h1>
  <p>Cookies are name-value-pair data object stored in your browser.  This tools lets you set and delete cookies.
...
<div class="w3-half">
  ...
  <h3>Set Cookies</h3><br>
  
 <i class="fas fa-cookie w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
...
<div class="w3-half">
  <div class="w3-card w3-container" style="min-height:460px">
  <h3>Delete Cookies</h3><br>
  <i class="fas fa-cookie-bite w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
    <div class="">
  ...
  include "tools\deleteCookieForm.php";?>
		...
		<ul class="w3-ul w3-left w3-hover-shadow w3-block">
			<li class="w3-black w3-xlarge w3-padding-32">JavaScript Cookie Reader</li>
			<li class="w3-padding-16"><h2>Current Cookies:</h2>
				<table
					id="jsCookies"
					class="w3-hoverable w3-striped w3-padding-16"
					width="100%"
				></table> <script>
