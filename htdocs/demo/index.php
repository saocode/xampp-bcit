...
<p>See <b>Menu</b> above for options.<br>
<!-- Footer -->
<footer class="w3-container  w3-center w3-opacity w3-light-grey w3-xlarge" style="margin-left:-16px; margin-top:8px">
...
<div class="w3-display-container w3-opacity-min w3-hover-opacity-off" style="transition:0.5s;width:100%">
    <img src="finn.jpg" alt="Finn" style="width:100%">
